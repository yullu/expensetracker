            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                @auth()
                        <ul class="navbar-nav me-auto mb-2 mb-md-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="{{ route('transactions') }}">Transactions</a>
                            </li>
...
<footer class="footer mt-auto py-3 bg-body-tertiary">
    <div class="container">
        <span class="text-body-secondary">@php echo date('Y') @endphp Copyright Expense-Tracker.</span>
    </div>
</footer>
